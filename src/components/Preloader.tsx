...
export function Preloader() {
  ...
  useEffect(() => {
    const i = setInterval(() => setP((v) => Math.min(v + 1.5, 100)), 20)
  ...
  return (
    <div className="fixed inset-0 bg-void flex flex-col items-center justify-center z-[100]">
      ...
      <div className="w-32 h-px bg-surface rounded-full overflow-hidden mb-6">
        <div
          className="h-full bg-gradient-to-r from-red to-red-hot transition-all duration-75"
          style={{ width: p + '%' }}
        />
      </div>
